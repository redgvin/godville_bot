...
function start_search(a) {
    function b() {
        a.search_cnt += 1, $.post(base_api_url, {
            a: get_cmd_id("m5S1KBfBxKhNWuu61EjC")
        }, function (b) {
...
function ScreenManager() {
    this.screen_created = !1, this.search_displayed = !1, this.search_cnt, this.state = new Hs, this.nm = new NM, this.hints = new Hints, this.ach = new Ach, this.force_msg_update_timer = 0, this.voices = new Voices, this.ui = new UILib, this.block_clbks = {}, this.pending_error = !1, this.page_layout = $.Storage.get("pl"), window.fb_frame ? this.page_layout = "2c" : this.page_layout || (this.page_layout = "3c"), this.page_layout == "3c" ? ($("#main_wrapper").addClass("page_wrapper"), this.h_blocks = {
        ...
        left: ["alls", "m_info", "m_equipment", "m_inventory"],
        center: ["m_control", "m_fight_log"],
        right: ["map", "opps", "o_info", "o_equipment", "o_inventory"]
    }) : this.page_layout == "2c" ? ($("#main_wrapper").addClass("page_wrapper_2c"), this.h_blocks = {
        left: ["stats", "ies_block"],
        center: ["control", "news", "diary"]
    }, this.as_blocks = {
        left: ["m_info", "m_equipment", "m_inventory", "map"],
        ...
        l_left: ["m_inventory"],
        left: ["alls", "m_info", "m_equipment"],
        center: ["m_control", "m_fight_log"],
        right: ["map", "opps", "o_info", "o_equipment"],
        r_right: ["o_inventory"]
    }), this.blocks_spinner = {
        stats: !0,
        diary: !0,
...
function Voices() {
    if (supports_local_storage()) {
        ...
        var b = !1;
        if (this.vdata_d == null) this.vdata_d = [], b = !0;
        else try {
...
function Messages(a, b) {
    this.nm = a, this.messages = {}, this.guild_messages = {}, this.guild_message_ids = {}, this.to_delete = [], this.to_update = [], this.loaded = !1, this.h_pages = {}, this.godname = b, this.gc_ext_perms = undefined, this.wr_perms = undefined;
    if (supports_local_storage()) {
...
function Hs() {
    ...
    if (this.cache_enabled()) {
        ...
        try {
            ...
            for (var d in this.pet_keys) {
                var e = this.pet_keys[d],
                    f = localStorage.getItem("fb_p_" + e);
    ...
    if (supports_local_storage()) {
        var h = localStorage.getItem("d_i"),
            i = localStorage.getItem("fb_gn");
...
var Loc = {
        ...
        a_voice2: "Бей противника ловчее, {мой герой|моя героиня}!",
        a_voice3: "Восстанови здоровье, {герой|героиня}!",
        ...
        set_motto_error_len: "Сожалеем, но девиз не может быть длиннее 25 символов.",
        set_motto_error: "Ошибка установки девиза. Проверьте ваш девиз и попробуйте еще раз.",
...
window.onload = function () {
    ...
    jQuery("#noJS").remove(), $("#menu_bar").hide(), load_failed_timer = window.setTimeout(function () {
        var a = $("#hero_block"),
            b = $('<table  style="text-align:center;width:760px;" align=center></table>'),
            c = [{
                n: "Google Chrome",
...
function (a) {
    a.fn.glow = function () {
        function j(b, c) {
            ...
            if (e.attr("glowing") != 1) {
                e.attr("glowing", 1);
                var g = a(e).css("background-color"),
                    j = f(i(e));
                if (!j) return;
                var l = 0,
                    m = parseInt(b / c, 10);
...
function (a, b) {
    ...
    a.position = {
        ...
        b = a.extend({}, b);
        var f, n, p, q, v, w, x = a(b.of),
            y = a.position.getWithinInfo(b.within),
            z = a.position.getScrollInfo(y),
            A = (b.collision || "flip").split(" "),
            B = {};
        return w = e(x), x[0].preventDefault && (b.at = "left top"), n = w.width, p = w.height, q = w.offset, v = a.extend({}, q), a.each(["my", "at"], function () {
            ...
            var e, j, k = a(this),
                ...
                o = d(this, "marginLeft"),
                u = d(this, "marginTop"),
                w = l + o + d(this, "marginRight") + z.width,
                C = m + u + d(this, "marginBottom") + z.height,
                E = a.extend({}, v),
                F = c(B.my, k.outerWidth(), k.outerHeight());
    ...
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        drag: function (b, c) {
            var d, e, f, g, h, i, j, k, l, m, n = a(this).data("ui-draggable"),
                ...
                s = c.offset.top,
                u = s + n.helperProportions.height;
            ...
            })), n.snapElements[l].snapping = !1) : ("inner" !== o.snapMode && (d = p >= Math.abs(j - u), e = p >= Math.abs(k - s), f = p >= Math.abs(h - r), g = p >= Math.abs(i - q), d && (c.position.top = n._convertPositionTo("relative", {
    ...
    a.widget("ui.droppable", {
        ...
        _drop: function (b, c) {
            ...
            return d && (d.currentItem || d.element)[0] !== this.element[0] ? (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                }), b.options.tolerance) ? (e = !0, !1) : undefined
        ...
        var f, g, h = (a.positionAbs || a.position.absolute).left,
            i = (a.positionAbs || a.position.absolute).top,
            j = h + a.helperProportions.width,
            k = i + a.helperProportions.height,
            l = c.offset.left,
            m = c.offset.top,
            n = l + c.proportions().width,
            o = m + c.proportions().height;
        switch (d) {
        case "fit":
            return h >= l && n >= j && i >= m && o >= k;
        case "intersect":
            return h + a.helperProportions.width / 2 > l && n > j - a.helperProportions.width / 2 && i + a.helperProportions.height / 2 > m && o > k - a.helperProportions.height / 2;
        case "pointer":
...
function (a) {
    a.browserTest = function (b, c) {
        ...
        b = (b.match(/Opera|Navigator|Minefield|KHTML|Chrome/) ? f(b, [
            [/(Firefox|MSIE|KHTML,\slike\sGecko|Konqueror)/, ""],
            ["Chrome Safari", "Chrome"],
            ["KHTML", "Konqueror"],
            ["Minefield", "Firefox"],
            ["Navigator", "Netscape"]
        ]) : b).toLowerCase(), a.browser = a.extend(c ? {} : a.browser, g(b, /(camino|chrome|firefox|netscape|konqueror|lynx|msie|opera|safari)/, [], /(camino|chrome|firefox|netscape|netscape6|opera|version|konqueror|lynx|msie|safari)(\/|\s)([a-z0-9\.\+]*?)(\;|dev|rel|\s|$)/)), a.layout = g(b, /(gecko|konqueror|msie|opera|webkit)/, [
            ["konqueror", "khtml"],
            ["msie", "trident"],
            ["opera", "presto"]
        ], /(applewebkit|rv|konqueror|msie)(\:|\/|\s)([a-z0-9\.]*?)(\;|\)|\s)/), a.os = {
...
function (a) {
    a.fn.popover = function (b) {
        var c = {
            ...
            b = a.extend(c, b),
            d = a(b.header).detach(),
            e = a(b.content).detach(),
            f = a('<div class="popover"><div class="triangle"></div><div class="header"></div><div class="content"></div></div>');
        ...
        var g = function (c) {
            ...
            var e = 0,
                ...
                h = a(document).width(),
                i = a(document).height(),
                j = parseInt(d.css("border-bottom-width")),
                k = f.outerWidth(!1),
                l = f.outerHeight(!1),
                m = c.outerWidth(!1),
                n = c.outerHeight(!1),
        ...
        this.each(function () {
            ...
            c.addClass("popover-button"), c.bind("showPopover", function () {
                ...
                }, 0), window.fb_frame && typeof FB != "undefined" && FB.Canvas && (FB.Canvas.setSize({
                    height: 1e3
                }), setTimeout(function () {
                    FB.Canvas.setSize()
                }, 100));
...
Hs.prototype.cache_enabled = function () {
    ...
    if (a) {
        ...
        for (var k in d) {
            var l = d[k],
                m = b[k];
            m ? (m.pos = l.pos, l.voice_id != m.voice_id && (m.voice_id = l.voice_id, m.s = "upd", c = !0)) : (b[k] = l, b[k].s = "add", c = !0)
        }
    }
    return c
    ...
    if (a) {
        ...
        for (idx in d) {
            var e = d[idx],
                f = a[e];
            if (b[e] == undefined) b[e] = f, b[e].s = "upd", c = !0;
            else {
                var g = b[e];
    ...
    if (this.stats.wood && this.stats.wood.value) {
        var a = this.stats.wood.value,
            b = parseFloat(a.substring(0, a.length - 1)) * 10;
        return b
    }
    return 0
...
NM.prototype.register = function (a, b) {
    ...
    }), $("#hint_bar").slideDown()), $("#hint_faq").hide(), $("#hint_capt").html(Loc.blog_notif_capt), $("#hint_content").html(localize(Loc.blog_notif_message, {
        id: a
    })), this.blog_hint_displayed = !0
    ...
    if (this.new_hints.length > 0) {
        ...
        this.hints[a].url ? $("#hint_faq").show().html(localize(Loc.hints_more_link, {
            url: this.hints[a].url
        })) : $("#hint_faq").show().html(Loc.hints_faq_link), this.hints[a]["new"] = !1, d.html(f), e.html(g);
        var h = this;
        h.current_idx = b, this.hint_displayed = !0, this.prev_button == undefined && (this.prev_button = $("#h_prev").html(Loc.hint_prev), this.prev_button.click(function () {
            ...
            if (h.blog_hint_displayed == !0) h.blog_hint_displayed = !1, h.show_by_id(h.new_hints[h.current_idx], h.current_idx);
            else {
                var b = [];
    ...
    if (d && b[d].title && b[d].desc && b[d].title.length > 0 && b[d].desc.length > 0) {
        ...
        f != "" ? g = localize(Loc.ach_title, {
            title: b[d].title,
            rank: f
        }) : g = b[d].title, $("#ach_capt").html(localize(Loc.new_ach_title_t, {
            title: g
        })), $("#ach_content").empty(), $("#ach_content").append($('<div class="ach_l"</div>>').html(b[d].desc));
        var h = $("#ach_c");
    ...
    for (var e in a) {
        ...
        if (b[f].title && b[f].desc) {
            var g = $('<div class="ach_l"></div>').appendTo(d),
                h = Loc["ach_title" + b[f].rank],
                i = "";
            h && (i = h);
            var j;
            i != "" ? j = localize(Loc.ach_title, {
                title: b[f].title,
                rank: i
            }) : j = b[f].title;
            var j = localize(Loc.ach_title, {
                title: b[f].title,
                rank: i
            });
    ...
    this.nm.notify_all.apply(this.nm, [
        ["messages"]
    ]), this.messages = {}, this.guild_messages = {}, this.guild_message_ids = {}, this.to_delete = [], this.to_update = [], this.h_friends = {}, this.fr_upd_cnt = 0, this.m_id = undefined, this.gc_m_id = undefined, this.godname = "", this.loaded = !1
    ...
    for (friend_name in this.h_friends) c[friend_name] == undefined && (this.h_friends[friend_name].s = "del", this.to_delete.push(friend_name));
    for (idx in a) {
        friend = a[idx];
        if (this.h_friends[friend.name] == undefined) this.h_friends[friend.name] = friend, this.loaded && (this.h_friends[friend.name].s = "new", this.h_friends[friend.name].ms = "upd"), b = !0, this.clear_msg_for_friend(friend.name);
        else {
            old_f = this.h_friends[friend.name];
            var d = old_f.msg,
                e = friend.msg;
            if (d == null && e || d && e == null || d && e && d.id != e.id) this.h_friends[friend.name].msg = friend.msg, b = !0, this.clear_msg_for_friend(friend.name), this.to_update.push(friend.name), e && d && e.sent_at > d.sent_at && (this.h_friends[friend.name].ms = "upd")
        }
        var f = this.h_friends[friend.name].ms;
        f == "upd" && (gv_log("mark as new from " + friend.name), this.fr_upd_cnt += 1)
    }
    this.friends = a, gv_log(this.h_friends), $(".msg_spinner").hide(), this.loaded = !0, this.nm.notify_all.apply(this.nm, [
        ["messages"]
    ]), this.fr_upd_cnt > 0 && this.nm.notify_all.apply(this.nm, [
        ["messages_badge"]
    ]), this.save_state()
    ...
    if (this.m_id != a) {
        ...
        var c = this;
        $.post(base_api_url, {
            a: get_cmd_id("3hOqa3hA2Gjh7tEWSD5T")
        }, function (a) {
    ...
    return !1
}, Messages.prototype.check_messages_gc = function (a, b) {
    var c = this;
    this.gc_m_id != a && (this.new_gc_m_id = a, this.gc_m_id == null && (this.gc_m_id = a, c.save_state_gc()), c.nm.notify_all.apply(c.nm, [
        ["gc_mid"]
    ]), this.get_gc_msg_cnt() > 0 && c.nm.notify_all.apply(c.nm, [
        ["gc_msg_badge"]
    ]))
    ...
    this.messages[a] == undefined ? $.post(base_api_url, {
        ...
        c.status == "success" && (c.ug && (b.h_friends[a].ug = c.ug), c.hg && (b.h_friends[a].hg = c.hg), b.h_pages[a] = 1, b.messages[a] = c.msgs.reverse(), b.nm.notify_all.apply(b.nm, [
            ["m_" + a]
        ]))
    }) : b.nm.notify_all.apply(b.nm, [
        ["m_" + a]
    ])
    ...
    $.post(base_api_url, {
        ...
        d.status == "success" && (d.ug && (c.h_friends[a].ug = d.ug), d.hg && (c.h_friends[a].hg = d.hg), d.msgs.length > 0 && (c.h_pages[a] = b), c.messages[a] = d.msgs.reverse().concat(c.messages[a]), c.nm.notify_all.apply(c.nm, [
            ["m_" + a]
        ]))
    })
}, Messages.prototype.mark_as_read = function (a) {
    this.h_friends[a] && this.h_friends[a].ms && this.h_friends[a] && this.h_friends[a].ms == "upd" && (delete this.h_friends[a].ms, this.fr_upd_cnt > 0 && (this.fr_upd_cnt -= 1), this.nm.notify_all.apply(this.nm, [
        ["messages_badge"]
    ]), this.save_state())
    ...
    this.clear_msg_for_friend(a), this.nm.notify_all.apply(this.nm, [
        ["m_" + a]
    ])
...
}, Messages.prototype.process_msg_for_guild = function (a, b, c) {
    a.guild_messages[b] == undefined && (a.guild_messages[b] = []);
    if (!(c.length == 0 && a.guild_messages[b].length > 0)) {
        var d = 0;
        for (idx in c) {
            var e = c[idx];
            e.id > d && (d = e.id), a.guild_message_ids[e.id] == undefined && (a.guild_message_ids[e.id] = !0, a.guild_messages[b].push(e))
        }
        a.gc_m_id = a.new_gc_m_id = d, a.nm.notify_all.apply(a.nm, [
            ["gc_" + b]
        ]), a.nm.notify_all.apply(a.nm, [
            ["gc_msg_badge"]
        ]), a.save_state_gc()
    }
    ...
    if (this.guild_messages[a] == undefined || c.new_gc_m_id != b) {
        ...
        b && (d.sid = b), this.gc_ext_perms == undefined && (d.perms = "1"), $.post(base_api_url, {
            a: get_cmd_id("nYrBGlddZVxNgxJLFffQ"),
            b: prepare_args(JSON.stringify(d))
        }, function (b) {
            b.status == "success" ? (b.wr_p != undefined && (c.gc_ext_perms = b.ext_p, c.wr_perms = b.wr_p), c.process_msg_for_guild(c, a, b.msg.reverse())) : b.status == "error" && b.desc && (c.guild_messages[a] = [], c.guild_message_ids = {}, c.gc_error = b.desc, c.nm.notify_all.apply(c.nm, [
                ["gc_" + a]
            ]))
        });
        return !0
    }
    c.nm.notify_all.apply(c.nm, [
        ["gc_" + a]
    ]);
    return !1
    ...
    this.godname = this.state.godname(), this.nm.notify_all.apply(this.nm, [
        ["pantheons"]
    ]), this.loaded == !1, this.fetch_updates(this, null)
    ...
    for (var c in a) {
        ...
        for (var f in d.pantheons) {
            var g = d.pantheons[f],
                h;
            if (e[f] == undefined) e[f] = g, this.old_pantheons["group" + c].data[f] = g, b = !0;
            else {
                h = e[f];
    ...
    if (b || i > 0) this.nm.notify_all.apply(this.nm, [
        ["pantheons"]
    ]), this.nm.notify_all.apply(this.nm, [
        ["pantheons_badge"]
    ]), supports_local_storage() && localStorage.setItem("p__grp_o" + JSON.stringify(this.godname), JSON.stringify(this.old_pantheons))
}, Pantheons.prototype.fetch_updates = function (a, b) {
    $.post(base_api_url, {
        a: get_cmd_id("fjQtRFHERdTEvAbY3p2m")
    }, function (c) {
    ...
    if (this.default_list) {
        ...
        if (this.get_voices(undefined, !0, "").length == 0) {
            var a = ["a_voice3", "a_voice2", "a_voice1"];
...
var g_regex = /\{([^}^\|]*?)\|([^{^\|]*?)\}/g,
    ...
    time_ago_interval = function (a) {
        var b = new Date,
            c = b - a;
        return c < 6e4 ? localize(Loc.d_ago_s, {
            x: Math.floor(c / 1e3)
        }) : c < 36e5 ? localize(Loc.d_ago_m, {
            x: Math.floor(c / 60 / 1e3)
        }) : c < 864e5 ? localize(Loc.d_ago_h, {
            x: Math.floor(c / 3600 / 1e3)
        }) : localize(Loc.d_ago_d, {
            x: Math.floor(c / 3600 / 24 / 1e3)
        })
    },
    get_days_ago = function (a) {
        ...
        default:
            return c < 0 ? Loc.d_today : c == 3 || c == 4 ? localize(Loc.d_3_4days_ago, {
                days: c
            }) : localize(Loc.d_xdays_ago, {
                days: c
            })
        }
    };
WebNotify.prototype.update = function () {
    ...
    if (typeof Notification != "undefined") {
        ...
        a == "duel" && this.state.fight_type() == "dungeon" && (a = "dungeon");
        var c = localize(Loc["dn_" + a], b),
            d = this;
        try {
            d.show_notification(c)
        } catch (e) {
            window.Notification.requestPermission(function (a) {
                d.permission = a, d.permission == "granted" && d.show_notification(c)
            })
        }
    }
    ...
    var a = null,
        ...
        e = !1,
        f = this.cache.inv,
        g = hash_keys(this.state.inventory),
        h = hash_keys(f),
        i = subtract_arrays(h, g);
    for (var j in i) delete f[i[j]], e = !0;
    for (var j in this.state.inventory) {
        var k = this.state.inventory[j];
        if (j == Loc.dn_invite_name)
            if (!f[j] || f[j].cnt != k.cnt) {
                if (!f[j] || f[j].cnt > k.cnt) d = !0;
                f[j] = {
                    cnt: k.cnt
                }, c = !0
            }
        if (k.activate_by_user)
            if (!f[j] || f[j].cnt != k.cnt) {
    ...
    c.c_e = $("<div class='l_capt'>" + a + "</div>"), c.v_e = $("<div class='l_val'>" + safe_name(b) + "</div>"), c.append(c.c_e), c.append(c.v_e), c.display = function () {
    ...
    if (d) {
        ...
        var k = function (a) {
            return function () {
                if (a.edit_save.hasClass("div_link") != !1) {
                    var b = $("#pet_name_input").val(),
                        d = confirm(localize(Loc.pet_rename_confirm, {
                            name: b
                        }));
    ...
    c.p_progress = $("<div class='p_val'></div>"), c.append(c.p_progress), c.setProgress = function (c, d, e, f) {
        var d = typeof d != "undefined" ? d : 1e3,
            e = typeof e != "undefined" ? e : "swing",
            f = typeof f != "undefined" ? f : undefined,
            g = Math.round(Math.floor(c / b * 100)) + "%",
            h = c + "%";
        a && (h = localize(a, {
            prct: h
        })), this.attr("title", h), f ? jQuery(this.p_progress).clearQueue().animate({
            width: g
        }, d, e, f) : jQuery(this.p_progress).clearQueue().animate({
            width: g
        }, d, e)
        ...
        a && (e = localize(a, {
            prct: e
        })), this.attr("title", e), this.p_progress.clearQueue(), this.p_progress.width(d)
    ...
    f.p_line = p_line = $("<div class='p_bar'></div>"), f.p_progress = p_progress = $("<div class='p_val'></div>"), f.p_line = p_line, f.setProgress = function (a, b) {
        ...
        e && (d = localize(e, {
            prct: c
        })), this.p_line.attr("title", d), b ? this.p_progress.width(c) : jQuery(this.p_progress).clearQueue().animate({
            width: c
        }, 1e3)
    ...
    var f = {
            value: b.value / c.value * 100
        },
        g = this.line_w_progress(a, b, f, d, e);
    g.update = function (a) {
        var d = b.value / c.value * 100;
        d > 100 && (d = 100), f = {
            value: d
        }, this.v_e.html(b.value + " / " + c.value), this.setProgress ? this.setProgress(f.value, a) : gv_error("no setProgress for element: " + g.attr("id"))
    }, g.display = function () {
    ...
    d.value == 0 && e.value == 0 && f.attr("style", "display:none;"), b && f.v_e.addClass("div_link");
    var g = f.v_e;
    g.popover({
        header: "#awl_popover > .fh_header",
        content: "#awl_popover > .fh_content"
    });
    var h = $(".last_fight_link"),
        i = $(".ext_stats_link");
    ...
    k.html(Loc.ext_stats_link), k.attr("href", "/meter/gods/" + a.state.godname()), b && (f.v_e.attr("title", Loc.win_loss_title), f.v_e.click(function () {
        ...
        c.show(), $.post(base_api_url, {
            a: get_cmd_id("AJ53peA1Kl3eoRv1fnbW")
        }, function (a) {
            ...
            if (a && a.status == "success") {
                ...
                for (idx in a.fights_list) {
                    var d = a.fights_list[idx],
                        e = $('<div class="wl_line"></div>');
    ...
    c.hightlight = !1, b.aura_name() == "" && c.attr("style", "display:none;"), c.display = function () {
        if (b.aura_name() != "") {
            ...
            var a = b.stats.aura_time.value,
                c = Math.floor(a / 3600),
                d = Math.floor(a / 60 - c * 60);
            ...
            var g = $("<a></a>");
            g.attr("href", Loc.wiki_prefix + "/" + localize(Loc.wiki_aura_prefix, {
                name: b.aura_name()
            })), g.attr("target", "_blank"), g.attr("title", localize(Loc.wiki_aura_title, {
                name: b.aura_name()
            })), g.html(b.aura_name()), g.click(function () {
                window.open(this.href);
                return !1
    ...
    g.update = function () {
        ...
        if (b == undefined || b.value == "") {
            ...
            e.stats.c_town && e.stats.c_town.value && (g = e.stats.c_town.value), this.v_e.attr("title", localize(Loc.nearby_town, {
                town: g
            }))
        } else {
            this.c_e.html(a);
            var h = $("<a></a>");
            h.attr("href", Loc.wiki_prefix + "/" + b.value), h.attr("target", "_blank"), h.attr("title", localize(Loc.town_wiki_title, {
                town: b.value
            })), h.html(b.value), h.click(function () {
                window.open(this.href);
                return !1
            }), this.v_e.html(h)
        }
    ...
    if (a && a.value) {
        d = $("<span></span>").html("庙");
        var f = new Date;
        e = e + 1, f.setISO8601(a.value), d.attr("title", localize(Loc.t_award_title, {
            time: formatted_date_full(f, !0)
        }))
    }
    var g;
    if (b && b.value) {
        ...
        var f = new Date;
        f.setISO8601(b.value), g.attr("title", localize(Loc.p_award_title, {
            time: formatted_date_full(f, !0)
        }))
    }
    var h;
    if (c && c.value) {
        ...
        var f = new Date;
        f.setISO8601(c.value), h.attr("title", localize(Loc.a_award_title, {
            time: formatted_date_full(f, !0)
        }))
    }
    if (d || g || h) {
    ...
    var e = $('<form id="invite_friend" action="#" method="post"></form>'),
        f = $('<div id="invite_email_label" class="line"></div>').html(Loc.invites_email_name).appendTo(e);
    ...
    var i = function (a, c) {
            ...
            d.show(), $.post(base_api_url, {
                ...
                var c = $("#invite_email"),
                    e = $("#invite_message"),
                    f = $("#invite_error");
                if (b.status != "success") f.addClass("t_error"), b.desc || (b.desc = Loc.network_error);
                else {
    ...
    var i, j, k, l = Loc.i_intro_monster,
        m;
    ...
    var p = this,
        ...
        s = function (b) {
            ...
            if (b.activate_by_user) {
                var e = $('<a href="#" class="no_link item_act_link_div"></a>').html("@"),
                    f, g = !1;
                if (d.is_fighting() == !1) {
                    var h = {
                        desc: b.description,
                        godpower: b.needs_godpower
                    };
            ...
            if (b.activate_on_arena) {
                var e = $('<div class="item_act_link_div"></div>').html("@"),
                    f, g = !1;
                if (d.is_fighting() == !0)
                    if (a.state.fight_type() == "dungeon") f = Loc.item_activate_no_dungeon;
                    else {
                        var h = {
                            desc: b.description,
                            godpower: b.needs_godpower
    ...
    $.each(e, function (a, b) {
        ...
        $.each(e, function (b, e) {
            if (e) {
                e.pos != -1 && (a[e.pos] = e);
                if (e.s == "add" && e.li == undefined) d[e.pos] = e;
                else if (e.s == "del") c.push(e);
                else if (e.s == "upd" || e.activate_by_user || e.activate_on_arena) f[e.pos] = e
            }
        });
        ...
        }), a.length == 0 && this.header.html() == j ? (this.header.html(k), this.header.addClass("inv_empty")) : a.length != 0 && this.header.html() == k && (this.header.html(j), this.header.removeClass("inv_empty"))
    }, n.update.call(n);
    return n
    ...
    var g = function (a, c) {
            return function (d) {
                b && b.show(), $.post(base_api_url, {
                    ...
                    if (d.hero) {
                        ...
                        g.empty(), e.godname && f.god_name_line(Loc.gname_a_capt, {
                            godname: {
                                value: e.godname
                            }
                        }).appendTo(g), e.motto && f.motto_line(undefined, Loc.motto_capt, {
                            value: e.motto
                        }).appendTo(g), e.clan && f.guild_name_line(Loc.guild_capt, {
                            clan: {
                                value: e.clan
                            },
                            level: {
                        ...
                        }).appendTo(g), (e.arena_won || e.arena_lost) && f.win_lost_ext(Loc.win_loss_capt, e.arena_won, e.arena_lost, e.godname).appendTo(g), e.alignment && f.simple_line(Loc.alignment_capt, {
                            value: e.alignment
                        }).appendTo(g), e.gold_approx && f.simple_line(Loc.gold_capt, {
                            value: e.gold_approx
                        }).appendTo(g), e.bricks_cnt && f.simple_line(Loc.bricks_capt, {
                            value: e.bricks_cnt / 10 + "%"
                        }).appendTo(g), e.wood && f.simple_line(Loc.wood_capt, {
                            value: e.wood
                        }).appendTo(g);
        ...
        h = function (a) {
            var b = $("<div class='line'></div>"),
                c = $("<div class='opp_n'></div>").text(a.hero);
            c.appendTo(b);
    ...
    var i, j = function (a, b, f, g) {
            ...
            var p = $("<div class='d_msg'></div>"),
                q = f.msg;
            f.infl && p.addClass("m_infl");
            var r = $("<div></div>").text(f.msg),
                q = r.html();
            if (f.m_wiki) {
                var s = $("<a></a>");
            ...
            if (f.uph_author) {
                var s = $("<a>✑</a>");
                s.attr("href", "/gods/" + f.uph_author), s.attr("target", "_blank"), s.attr("title", localize(Loc.uph_author, {
                    author: f.uph_author
                })), s.click(function () {
                    window.open(this.href);
                    return !1
            ...
            if (f.voice_id) {
                ...
                u.attr("title", localize(Loc.shout_up_t, {
                    author: f.voice_a
                }));
                var v = $('<a class="no_link div_link vote_link">−</a>');
                v.attr("title", localize(Loc.shout_down_t, {
                    author: f.voice_a
                }));
                var w = $('<a class="no_link div_link vote_link">➠</a>'),
                    x = f.voice_a;
                w.attr("title", localize(Loc.shout_ppage, {
                    author: x
                }));
            ...
            if (d.d_share_enabled) {
                var B = "";
                g && a == 0 && (B = "top:0px;"), b.sn_links = $('<div class="d_line_links" style="display:none;' + B + '"></div>').appendTo(b);
                var C = encodeURIComponent("http://" + Loc.our_domain),
                    m = new Date;
                m.setISO8601(f.time), k = formatted_date(h, !0);
                var D = k + " " + f.msg,
                    E;
                Loc.locale == "ru" ? E = ["Годвилль - игра без игрока", "Годвилль - город богов и героев", "Годвилль - царство рандома", "Годвилль - обитель случайности", "Годвилль - божественная комедия", "Годвилль - с нами боги!"] : E = ["Godville - Gods and Heroes", "Godville - Zero Player Game", "Godville - Gods With Us"];
                var F = encodeURIComponent(E[Math.floor(Math.random() * E.length)]),
                    G = $('<div class="div_link fb_share"></div>').append('<a target="_blank" href="http://www.facebook.com/sharer.php?s=100&&p[url]=' + C + "&&p[title]=" + F + "&&p[summary]=" + D + '"><img src="/images/f_logo.png"/></a>').attr("title", Loc.fbs_share_title),
                    H = $('<div class="d_tweet"></div>').append($('<a target="_blank" href="http://twitter.com/share?url=' + C + "&text=" + "%23" + Loc.twit_tag + "+" + D + "%0A" + '"><img src="/images/twitter_icon.ico"/></a>').attr("title", Loc.twt_share_title));
                if (Loc.locale == "ru") {
                    var I = C;
                    I = encodeURIComponent("http://vk.com/ogodville");
                    var J = ["игра без игрока", "город богов и героев", "царство рандома", "обитель случайности", "божественная комедия", "с нами боги!"],
                        K = encodeURIComponent(J[Math.floor(Math.random() * J.length)]),
                        L = $('<a target="_blank" href="http://vk.com/share.php?url=' + I + "&noparse=true&title=Годвилль+-+" + K + "&description=" + encodeURIComponent(D) + '"><img src="/images/vk_icon.png"/></a>').attr("title", Loc.vk_share_title),
                        M = $('<div class="d_vk"></div>').append(L);
                    M.appendTo(b.sn_links), L.click(function () {
                        if (D.length > 190) {
                ...
                H.appendTo(b.sn_links), G.appendTo(b.sn_links), b.sn_links.append($('<div class="triangle"></div>')), Loc.locale != "ru" && G.click(HFB.diary_click_f(k + ": " + f.msg));
                var N = function (a) {
                        return function () {
                ...
                b.mouseenter(N(b)), b.mouseleave(O(b))
            }
            return b
        },
        k = [];
    $.each(b, function (a, b) {
        ...
        $.each(b, function (b, g) {
            if (g) {
                g.pos != -1 && (a[g.pos] = g);
                if (g.s == "add")
                    if (g.li && h && h.is_visible && h.is_visible() == !0) g.s = "processed", g.li.clearQueue().glow(glow_color, glow_time);
                    else {
                        var j = g.pos;
    ...
    if (f) {
        var j = a.get_right_slot_by_parent_ref(b),
            k = $("<span id='d_refresh' style='' class='refresh_ch'>↻</span>").prependTo(j);
        k.addClass("header_cursor"), k.attr("title", Loc.refresh_title), k.click(i(a, j))
    }
    var l = a.get_left_slot_by_parent_ref(b),
        m = "▲";
    e.value == "up" && (m = "▼");
    ...
    if (supports_input_placeholder() == !1) {
        var k = function (a, b) {
            ...
            m = $("#god_phrase"),
            n = $('<span id="hint_label" class="hint_label;"></span>').html(Loc.input_voice_hint);
    ...
    j.append(t.append(j.send_button)), supports_local_storage() && (j.last_vocies = $('<div class="div_link_nu gvl_popover">✎</div>'), j.last_vocies.attr("title", Loc.last_voices_title), q.prepend(j.last_vocies), j.last_vocies.popover({
        ...
        var b = $("#gv_popover_c");
        b.empty();
        var c = [].concat(a.voices.get_voices(a.state.level(), a.state.is_fighting(), a.state.fight_type())).reverse(),
            d = c.length,
            e = $('<div style="display:none;" class="gv_list_empty"></div>').html(Loc.last_voices_empty).appendTo(b);
        if (c.length == 0) e.show();
        else
            for (idx in c) {
                var f = c[idx],
                    g = $('<div class="wl_line"></div>'),
                    h = $('<div class="gv_text div_link"></div>').text(f).appendTo(g);
    ...
    var u = function (a, b) {
            a.encourage.removeClass("div_link"), a.punish.removeClass("div_link"), a.miracle.removeClass("div_link"), a.to_arena.removeClass("div_link"), a.to_chf.removeClass("div_link"), a.to_dungeon.removeClass("div_link"), a.resurrect.removeClass("div_link"), a.action_sent = !0, r({
                action: b
            }, a.sm);
            return !1
        },
        v = function (a, b, c) {
            return function () {
                ...
                if (b == "to_dungeon") $.post(base_api_url, {
                    a: get_cmd_id("yYKfxTjrO3fuODiRwOOJ")
                }, function (c) {
    ...
    A.appendTo(x), g.to_chf.popover({
        header: "#chf_popover > .fh_header",
        content: "#chf_popover > .fh_content"
    });
    var C = this,
        D = $("#chf_popover_c"),
        E = $('<div class="chf_line chf_filt"></div>'),
        F = $("<input></input>").attr({
            "class": "input_text",
            type: "text"
        });
    F.attr("placeholder", Loc.friend_filter_placeholder), E.append(F), E.insertBefore($("#chf_popover_c").parent()), F.change(function () {
        ...
        if (a.messages.friends.length == 0) D.append($('<div class="chf_line"></div>').html(Loc.chf_no_friends));
        else {
            ...
            $.each(c, function (a, b) {
                ...
                c.click(function (a) {
                    var c = confirm(localize(Loc.chf_fr_confirm, {
                        godname: b.name
                    }));
                    if (!c) return !1;
                    r({
                        action: "chf",
                        opp: b.name
                    }, g.sm), $.fn.popover.openedPopup.trigger("hidePopover")
                }), D.append(c)
            }), F.change()
        }
        g.to_chf.trigger("showPopover")
    }), g.limit_block = $("<div style='display:none;'></div>").html(localize(Loc.arena_actions, {
        actions: 0
    })), x.append(g.limit_block), g.actions2 = x, g.actions = $('<div id="actions"></div>'), g.append(g.actions.append(w).append(x)), g.acc = $('<div style="display:none;" class="acc_line line"></div>'), g.acc.attr("title", Loc.acc_title), g.charges = $('<div class="battery"></div>'), $('<span class="ch_title"></span>').html(Loc.charges_title).appendTo(g.charges), g.acc_progress = this.acc_progress(), g.acc_progress.setProgress(c.accumulator()), g.charges.append(g.acc_progress), g.acc_val = $('<span class="acc_val"></span>').html(c.accumulator()).appendTo(g.charges);
    var G = function (a) {
        return function () {
            if (a.charge_action_sent || !$(this).hasClass("div_link")) return !1;
            a.charge_action_sent = !0, r({
                action: "accumulate"
            }, a.sm);
            return !1
        }
    ...
    var H = function (b) {
        return function () {
            ...
            if (c.godpower() > a.gp_confirm_thre_val()) {
                var d = confirm(localize(Loc.acc_discharge_confirm, {
                    godpower: c.godpower()
                }));
                if (!d) return !1
            }
            b.discharge_action_sent = !0, b.acc_discharge.removeClass("div_link"), r({
                action: "acc_restore"
            }, b.sm);
            return !1
        }
    ...
    window.fb_frame || window.vk_frame ? (J.html("&nbsp;"), J.removeClass("hch_link")) : J.click(function () {
        ...
        if (c.health() > 0 && c.arena_available() && c.is_fighting() == !1) c.arena_disabled() ? (c.health() > 10 && c.level() >= 7 && (this.to_arena_msg.attr("title", Loc.send_to_arena_disabled_title), this.to_arena_msg.html(Loc.arena_unavailable_link), this.to_arena_msg.show(), this.to_arena.removeClass("div_link"), i = !1), k = !1) : (this.to_arena_msg.hide(), this.to_arena.addClass("div_link"), i = !0);
        else if (c.arena_available() == !1) {
            ...
            if (c.stats.arena_send_after && c.stats.arena_send_after.value && c.fight_type() != "monster" && !c.is_fighting()) {
                var m = c.stats.arena_send_after.value,
                    n = Math.floor(m / 3600),
                    o = Math.floor(m / 60 - n * 60);
                this.to_arena_msg.html(Loc.arena_avaialble_in);
                var p;
                n > 0 ? p = localize(Loc.arena_avaialble_time, {
                    hours: n,
                    minutes: o
                }) : p = localize(Loc.arena_avaialble_time_m, {
                    minutes: o
                }), this.to_arena_msg.append($('<span class="arena_time_str"></span>').html(p)), this.to_arena_msg.show(), i = !1
        ...
        } else this.to_arena.addClass("div_link"), this.to_arena.html(Loc.to_arena_link), this.to_arena.attr("title", Loc.send_to_arena_title), i = i && !0, this.to_arena_msg.hide(); if (c.dungeon_available() == !1) {
            this.to_dungeon.removeClass("div_link");
            if (c.stats.d_send_after && c.stats.d_send_after.value && !c.is_fighting()) {
                var m = c.stats.d_send_after.value,
                    n = Math.floor(m / 3600),
                    o = Math.floor(m / 60 - n * 60);
                ...
                n > 0 ? p = localize(Loc.arena_avaialble_time, {
                    ...
                    minutes: o
                }), this.to_dungeon_msg.append($('<span class="arena_time_str"></span>').html(p)), this.to_dungeon_msg.show(), k = !1
            } else k = !1
        ...
        if (c.arena_disabled() || c.is_fighting() == !0) this.to_chf_after.css("display") != "none" && this.to_chf_after.hide();
        else if (c.stats.chfr_after && c.stats.chfr_after.value != undefined && !c.is_fighting())
            if (c.stats.chfr_after.value == 0 || c.health() == 0) this.to_chf_after.css("display") != "none" && this.to_chf_after.hide();
            else {
                var m = c.stats.chfr_after.value,
                    n = Math.floor(m / 3600),
                    o = Math.floor(m / 60 - n * 60);
                ...
                n > 0 ? p = localize(Loc.arena_avaialble_time, {
                    ...
                    minutes: o
                }), this.to_chf_after.append($('<span class="arena_time_str"></span>').html(p)), this.to_chf_after.css("display") == "none" && this.to_chf_after.show()
            }
        c.stats.is_arena_available && c.stats.is_arena_available.value && (i == !0 && c.health() > 0 ? i = i && !0 : i = !1), c.health() == 0 ? (i = !1, k = !1) : i = i & !0, i && this.to_arena.css("display") == "none" && this.to_arena.slideDown(), i == !1 && this.to_arena.css("display") != "none" && this.to_arena.slideUp(), k && this.to_dungeon.css("display") == "none" && this.to_dungeon.slideDown(), k == !1 && this.to_dungeon.css("display") != "none" && this.to_dungeon.slideUp(), c.health() <= 0 ? (this.resurrect.css("display") == "none" && this.resurrect.show(), this.miracle.hide(), this.to_dungeon.hide()) : this.resurrect.css("display") != "none" && this.resurrect.hide(), c.godpower() >= 100 && c.accumulator() < 3 ? this.acc_charge.css("display") == "none" && this.acc_charge.show() : this.acc_charge.css("display") != "none" && this.acc_charge.hide();
        var q;
    ...
    c.restore_pet = $("<a href='#' class='no_link div_link' style='display:none;text-align:center;'></a>").html(Loc.restore_pet_link), c.restore_pet.attr("title", Loc.restore_pet_title), c.restore_pet.appendTo(g), c.restore_pet.popover({
        ...
        if (a.state.pets == undefined || a.state.pets.length == 0) d.append($('<div class="pets_line"></div>').html(Loc.no_stored_pets));
        else
            for (var e = 0; e < a.state.stats.pets_max.value; e++) {
                var f = a.state.pets[e],
                    g = $('<div class="pets_line"></div>');
                if (f == undefined) g.attr("style", "text-align:center"), g.html(Loc.pets_empty);
                else {
                    var i = f.pet_class,
                        j = $("<a>");
                    ...
                    var l = $('<a href="#" class="no_link item_act_link_div"></a>').html("@"),
                        m = Loc.restore_pet_link_no_gp,
                        n = !1;
                    ...
                    var o = function (b, c) {
                        return function () {
                            var d = confirm(localize(Loc.restore_pet_link_confirm, {
                                name: b
                            }));
                            if (!d) return !1;
                            h({
    ...
    c.store_pet.click(function () {
        ...
        if (e.has_pet || b >= 1e3) {
            ...
            if (b >= 1e3 && e.has_pet) {
                c.store_pet.show();
                var g = a.state.pets_max(),
                    h = a.state.pets.length;
    ...
    var c = $("<div style='margin:0.2em 0.5em 0.5em 0.5em;'></div>"),
        d = a.state,
        e = null;
    ...
    c.update = function () {
        d.d_map.length > 0 && (e == null && a.state.stats.daura && a.state.stats.daura.value && a.state.stats.daura.value.length > 0 && (e = $("<div style='text-align:center;'></div>").appendTo(c).html(a.state.stats.daura.value)), f.empty(), $.each(a.state.d_map, function (a, b) {
            var c = b.length * 20 + b.length,
                d = $("<div class='dml'></div>").attr("style", "width:" + c + "px").appendTo(f);
            $.each(b, function (a, b) {
    ...
    var g = $("<div class='div_link map_legend'></div>").appendTo(c).html(Loc.map_legend),
        h = $("<div style='display:none;padding-top:0.5em;margin-left:70px;'></div>").appendTo(c);
    ...
    if (d) {
        ...
        var i = function (a, b) {
                return function () {
                    ...
                    b.show(), a.pantheons.fetch_updates.apply(a.pantheons, [a.pantheons,
                        function (a) {
                            b.hide()
                        }
                    ])
            ...
            j = a.get_right_slot_by_parent_ref(h),
            k = $("<span style='display:none;' class='refresh_ch'>↻</span>").prependTo(j);
    ...
    b.update = function () {
        ...
        if (j == 0)
            ...
            } else b.panth_empty.css("display") == "none" && b.panth_empty.show();
        else {
    ...
    var e = function (a) {
            var b = $("<li></li>"),
                c = $('<span class="skill_name"></span>').html(a.name);
            b.append(c);
            var d;
    ...
    var c = $("<div id='turn_pbar' class='line' style='margin-bottom:1.0em;'></div>"),
        d = b.turn_progress,
        e = b.turn_length;
    ...
    ar_pb_update = function (a, b, d, e) {
        ...
        return function () {
            if (b && b.value != undefined) {
                b.value = b.value + d;
                if (b.value <= 100) f = !1, g = !1, b.value > 100 && (b.value = 100), c.progress_bar.setProgressNoAnim(b.value);
                else if (b.value > 103) {
                    if (f == !1) {
    ...
    c.interval_id = setInterval(ar_pb_update(f, d, j, a), i), c.sm = a, c.progress_bar.attr("title", ""), c.append(c.progress_bar), c.update = function () {
        ...
        var a = !1,
            b = parseInt(this.stats.turn_length.value),
            c
    };
    return c
}, UILib.prototype.create_arena_fight_log = function (a) {
    var b = a.a_blocks.m_fight_log,
        c = a.get_a_block_content("m_fight_log"),
        d = a.get_block_caption_by_parent_ref(b);
    log_header_up = function (a, b) {
        return function () {
            var c = "";
            a.fight_type() == "town" ? c = Loc.duel_arena_capt : a.fight_type() == "challenge" ? c = Loc.duel_challenge_capt : a.fight_type() == "dungeon" ? c = Loc.duel_dungeon_capt : a.fight_type() == "monster" || a.fight_type() == "monster_m" || a.fight_type() == "multi_monster" ? c = Loc.duel_monster_capt : c = Loc.duel_arena_travel, a.stats.arena_step_count && a.stats.arena_step_count.value && (c += localize(Loc.dual_arena_step, {
                step: a.stats.arena_step_count.value
            })), b.html(c)
        }
    ...
    return c ? localize(Loc.window_title, {
        godname: c.value,
        god_gender: e,
        hero_gender: f,
        hero_name: d.value
    ...
    var c = !1,
        d = !1;
    b.click(function () {
        $(".frbutton_m_pressed").trigger("click"), c = !0, jQuery.facebox.settings.closeImage = "/images/closelabel.png", jQuery.facebox.settings.loadingImage = "/images/loading.gif", jQuery.facebox({
            div: "#page_settings"
        });
        var a = $("#facebox");
        jQuery("div#facebox div.popup div.content").addClass("spage"), a.draggable({
            opacity: .5
        });
        return !1
        ...
        if (c && d == !1) {
            ...
            e.update = function () {
                var c = localize(Loc.fb_fr_invites_desc, {
                    count: a.state.invites_left()
                });
            ...
            var h = $('<div border="0" align="middle" style="displa:none;position:absolute;right:25px;top:30px;" class="spinner_img"></div>').appendTo(b),
                i = $("<ul></ul>"),
                j = $('<div class="set_line"</div>'),
                k = $("<input class='input_text fr_inv_filt' type='text'></input>");
            ...
            m.attr("value", Loc.invites_send_button), m.click(function () {
                ...
                var b = {
                    email: jQuery("#fb_invite_email").val(),
                    msg: jQuery("#fb_invite_message").val(),
                    b: !0
                };
                $.post(base_api_url, {
                    a: get_cmd_id("54pcE5UCp82zxcEQcBwj"),
                    b: prepare_args(JSON.stringify(b))
                }, function (b) {
                    h.hide();
                    var c = $("#fb_invite_error");
                    if (b.status != "success") c.addClass("error"), c.removeClass("success"), b.desc || (b.desc = Loc.network_error);
                    else {
            ...
            $('<div class="set_line"></div>').append(l).append(m).append(n).appendTo(b), h.show(), FB.api("me/friends", function (b) {
                ...
                for (var d in c) {
                    var e = c[d],
                        f = $('<li class="fb_fr_list_item"></li>'),
                        g = $('<div class="fb_fr_list_item_d"></div>').appendTo(f);
                    ...
                    var k = function (b) {
                        return function () {
                            var c = confirm(localize(Loc.fr_fr_invite_confirm, {
                                name: b.name
                            }));
                            if (!c) return !1;
    ...
    if (d) {
        ...
        var k = function (a) {
            return function () {
                if (a.edit_save.hasClass("div_link") != !1) {
                    var b = $("#shop_name_input").val(),
                        d = confirm(localize(Loc.shop_rename_confirm, {
                            name: b
                        }));
                    d && (a.save_spinner.show(), a.edit_save.hide(), $.post(base_api_url, {
                        ...
                        var e = d.status;
                        e == "success" ? (c.value = b, a.v_e.text(localize(Loc.shop_name_tmpl, {
                            name: b
                        })), a.edit_line.slideUp(), a.status_line.html("")) : d.desc && a.status_line.html(d.desc), a.save_spinner.hide(), a.edit_save.show()
                    }))
                }
            }
        };
    ...
    if (!e.trader_av()) c.attr("style", "display:none");
    else {
        var f = d;
        c.shop_name = this.shop_name_edit_line(a.state, Loc.shop_name, {
            value: localize(Loc.shop_name_tmpl, {
                name: e.stats.shop_name.value
            })
        }, e.shop_rename()), c.shop_name.appendTo(f), c.t_level = a.nm.register("t_level", this.line_w_progress(Loc.tlevel_capt, e.stats.t_level, e.stats.t_level_pr, "#F9B436", Loc.pr_level)), c.t_level.appendTo(f);
        var g = $('<div class="line"></div>').appendTo(f);
        ...
        var i = function (b) {
            return function (d) {
                ...
                e.show(), $.ajax({
                    ...
                    url: base_api_url,
                    data: {
                        a: get_cmd_id("CnV5dUTEijtCky822p0Z"),
                        b: prepare_args(JSON.stringify({
                            artifact: b
                        }))
                    },
                    success: function (a) {
                        e.hide();
                        var d = $("#tordr");
                        a.status != "success" ? (d.addClass("t_error"), a.display_string || (a.display_string = Loc.network_error), d.clearQueue(), d.html(a.display_string), d.slideDown().delay(7e3).slideUp()) : (d.removeClass("t_error"), d.hide()), c.orders.empty(), c.orders.append($('<div style="text-align:center;"></div>').text(localize(Loc.order_pending, {
                            order: b
                        })))
                    },
                    dataType: "json",
        ...
        c.show_order.click(function (b) {
            ...
            d.show(), $.ajax({
                ...
                url: base_api_url,
                data: {
                    a: get_cmd_id("NOi5hcPevRWvkbhsW5z5")
                },
                success: function (a) {
                    d.hide();
                    var b = $("#tordr");
                    ...
                    if (a.active) c.orders.append($('<div style="text-align:center;"></div>').text(localize(Loc.order_pending, {
                        order: a.active
                    })));
                    else if (a.orders) {
                        ...
                        $.each(a.orders, function (a, b) {
                            var c = $("<li></li>").text(b),
                                d = $('<a href="#" class="no_link item_act_link_div"></a>').html("@"),
                                g, h = !1;
...
var forced_update = function (a) {
    ...
    status_check = function (a) {
        return function () {
            $.post(base_api_url, {
                a: get_cmd_id("u2iZlzPPsST6a7jhFg4y")
            }, function (b) {
                b && b.status == "success" && b.hero && a.on_json.apply(a, [b])
            })
        }
    ...
    set_msg_update = function (a) {
        if (a.force_msg_update_timer != 0) gv_log("forced message update already scheduled. ignore.");
        else {
            var b = function (a) {
                return function () {
                    $.post(base_api_url, {
                        a: get_cmd_id("G4LFOuNINtvAFR1pJXTy")
                    }, function (b) {
    ...
    timeout = 0,
    interval_id = 0,
    turbo_image_click_func = function () {
        return function () {
...
ScreenManager.prototype.gp_confirm_thre_val = function () {
    ...
    var b = $('<div border="0" align="middle" style="display: none;" class="spinner_img"></div>'),
        c = $('<select id="layout_s" name="layout_s"></select>'),
        d = [{
            id: "3c",
            val: Loc.restore_columns3
        }, {
            id: "5c",
            val: Loc.restore_columns5
        }];
    for (idx in d) {
        var e = d[idx],
            f = $("<option value='" + e.id + "'>" + e.val + "</option>");
    ...
    if (!jQuery.browser.msie) {
        ...
        var b = $('<select id="theme_s" name="theme_s"></select>'),
            c = [{
                id: "th_retro",
                val: Loc.th_retro
            }, {
        ...
        this.state.ggender() == "f" && c.push({
            id: "th_pink",
            val: Loc.th_pink
        });
        for (idx in c) {
            var d = c[idx],
                e = $("<option value='" + d.id + "'>" + d.val + "</option>");
    ...
    var b = $('<select id="ampm_s" name="ampm_s"></select>'),
        c = [{
            id: "12h",
            val: Loc.am_pm_12h
        }, {
    ...
    if (this.page_layout == "3c") {
        var c = [].concat(this.h_blocks.left, this.h_blocks.center, this.h_blocks.right),
            d = this.get_blocks_for_column("hero", "left", c),
            e = this.get_blocks_for_column("hero", "center", c),
            f = this.get_blocks_for_column("hero", "right", c),
            g = [].concat(d, e, f),
            h = subtract_arrays(c, g);
        ...
        var c = [].concat(this.h_blocks.left, this.h_blocks.center),
            d = this.get_blocks_for_column("hero", "left", c),
            e = this.get_blocks_for_column("hero", "center", c),
            g = [].concat(d, e),
            h = subtract_arrays(c, g);
        ...
        var c = [].concat(this.h_blocks.l_left, this.h_blocks.left, this.h_blocks.center, this.h_blocks.right, this.h_blocks.r_right),
            i = this.get_blocks_for_column("hero", "l_left", c),
            d = this.get_blocks_for_column("hero", "left", c),
            e = this.get_blocks_for_column("hero", "center", c),
            f = this.get_blocks_for_column("hero", "right", c),
            j = this.get_blocks_for_column("hero", "r_right", c),
            g = [].concat(i, d, e, f, j),
            h = subtract_arrays(c, g);
    ...
    if (this.page_layout == "3c") this.a_blocks = {}, this.add_block("arena", this, this.a_blocks, $("#a_left_block"), this.get_blocks_for_column("arena", "left", this.as_blocks.left)), this.add_block("arena", this, this.a_blocks, $("#a_central_block"), this.get_blocks_for_column("arena", "center", this.as_blocks.center)), this.add_block("arena", this, this.a_blocks, $("#a_right_block"), this.get_blocks_for_column("arena", "right", this.as_blocks.right)), $("#a_left_left_block").remove(), $("#a_right_right_block").remove();
        ...
        this.a_blocks = {};
        var c = this.get_blocks_for_column("arena", "left", this.as_blocks.left),
            d = this.get_blocks_for_column("arena", "center", this.as_blocks.center);
        ...
        var e = [].concat(this.as_blocks.l_left, this.as_blocks.left),
            f = [].concat(this.as_blocks.right, this.as_blocks.r_right),
            g = [].concat(this.get_blocks_for_column("arena", "l_left", e), this.get_blocks_for_column("arena", "left", e));
    ...
    window.SM2_DEFER = !0;
    var c = window.location.protocol + "//" + document.domain;
    typeof SoundManager != "undefined" && window.soundManager.supported() && window.soundManager.play("mySound", c + "/" + a), $.getScript("/javascripts/sm2.js", function () {
        window.soundManager = new SoundManager, window.soundManager.beginDelayedInit(), window.soundManager.url = c + "/soundmanager2.swf", window.soundManager.debugMode = !1, window.soundManager.consoleOnly = !1, window.soundManager.onready(function () {
            window.soundManager.supported() && window.soundManager.play("mySound", c + "/" + a), b && setTimeout("document.location.href ='" + document.location.pathname + "'", 2e3)
        })
    })
}, ScreenManager.prototype.a_notify = function () {
    if (!document.createElement("audio").canPlayType) this.play_sound("arena.mp3", !0);
    else {
    ...
    if (b) {
        ...
        if (this.state.chf_pending() && !b.arena_fight) {
            ...
            $("#chf_content").append($("<div></div>").html(localize(Loc.chf_pending_text, {
                godname: f
            })));
            var g = $('<div id="chf_controls"></div>'),
                h = $('<div class="div_link chf_link"></div>').html(Loc.chf_button_accept).appendTo(g);
            h.click(c(e, "1", f));
    ...
    var h = function (a) {
        ...
        b.push({
            id: "other",
            msg: Loc.ideabox_other
        }), b.push({
            id: "bug_report",
            msg: Loc.ideabox_bug_report
        }), b.push({
            id: "idea",
            msg: Loc.ideabox_idea
        }), Loc.locale == "ru" && b.push({
            id: "payment",
            msg: Loc.ideabox_payment
        }), c.level() >= 10 && (b.push({
            id: "monster",
            msg: Loc.ideabox_monster
        }), b.push({
            id: "artifact",
            msg: Loc.ideabox_artifact
        }), b.push({
            id: "news_fields",
            msg: Loc.ideabox_news_fields
        }), b.push({
            id: "diary",
            msg: Loc.ideabox_diary
        })), c.level() >= 20 && (b.push({
            id: "quest",
            msg: Loc.ideabox_quest
        }), b.push({
            id: "equipment",
            msg: Loc.ideabox_equipment
        }), b.push({
            id: "duel",
            msg: Loc.ideabox_duel
        }), b.push({
            id: "dungeon",
            msg: Loc.ideabox_dungeon
        }), b.push({
            id: "newspaper",
            msg: Loc.ideabox_newspaper
        })), c.level() >= 10 && b.push({
            id: "content",
            msg: Loc.ideabox_content
        });
        for (idx in b) {
            var d = b[idx];
    ...
    $("<span class='ib_desc'></span>").html(Loc.ideabox_reference_desc).appendTo(l), $("<span class='idea_error' id='diary_reference_err'></span>").appendTo(l), form.diary_reference = $('<input id="diary_reference" name="diary_reference" type="text" value="" class="input_text"></input>').appendTo(form.id_diary), $('<div class="idea_notes"></div>').html(Loc.ideabox_diary_note).appendTo(form.id_diary), form.id_content = k("content").appendTo(form);
    var l = $("<div class='ib_capt'></div>").html(Loc.ideabox_content_text).appendTo(form.id_content);
    $("<span class='ib_desc'></span>").html(Loc.ideabox_content_text_desc).appendTo(l), $("<span class='idea_error' id='content_text_err'></span>").appendTo(l), form.content_text = $('<input id="content_text" name="content_text" type="text" value="" class="input_text"></input>').appendTo(form.id_content);
    var l = $("<div class='ib_capt'></div>").html(Loc.ideabox_content_reference).appendTo(form.id_content);
    $("<span class='idea_error' id='content_reference_err'></span>").appendTo(l), $("<span class='ib_desc'></span>").html(Loc.ideabox_content_reference_desc).appendTo(l), form.content_reference = $('<textarea class="input_text" id="content_reference" name="content_reference" rows="4" wrap="virtual;"></textarea>').appendTo(form.id_content), $('<div class="idea_notes"></div>').html(Loc.ideabox_content_note).appendTo(form.id_content), form.id_equipment = k("equipment").appendTo(form);
    ...
    var m = [{
        id: "equip_weapon",
        val: Loc.ideabox_eq_weapon
    }, {
        id: "equip_shield",
        val: Loc.ideabox_eq_shield
    }, {
        id: "equip_head",
        val: Loc.ideabox_eq_head
    }, {
        id: "equip_body",
        val: Loc.ideabox_eq_body
    }, {
        id: "equip_arms",
        val: Loc.ideabox_eq_arms
    }, {
        id: "equip_legs",
        val: Loc.ideabox_eq_legs
    }, {
        id: "equip_talisman",
        val: Loc.ideabox_eq_talisman
    }];
    for (idx in m) {
        var n = m[idx];
    ...
    var p = function (a, b) {
            var c = $("#" + a),
                d = $("#" + a + "_err");
            if (c.val().length > b) {
                d.html(localize(Loc.ideabox_error_max_length, {
                    len: b
                })), d.fadeIn();
                return !1
            }
        ...
        q = function (a, b) {
            var c = $("#" + a),
                d = $("#" + a + "_err");
            if (c.val().length < b) {
                d.html(localize(Loc.ideabox_error_min_length, {
                    len: b
                })), d.fadeIn();
                return !1
            }
        ...
        u = function (b, c) {
            ...
            d.show(), c.send_button.attr("disabled", "disabled"), c.status_message.hide(), $.post(base_api_url, {
                a: get_cmd_id("QCFRPkOrNhNB5tAZhEy5"),
                b: prepare_args(JSON.stringify(s(c)))
            }, function (a) {
                d.hide(), a.status != "success" ? (c.status_message.addClass("t_error"), a.desc || (a.desc = Loc.network_error)) : (c.status_message.removeClass("t_error"), c.status_message.html(Loc.ideabox_submit_success), $inputs = jQuery("#send_feedback_form .input_text"), $inputs.each(function () {
                    $(this).val("")
    ...
    a && a.gc_mid != undefined && a.gc_n == this.state.guild() && this.messages.check_messages_gc.apply(this.messages, [a.gc_mid, this.state.godname()])
    ...
    var a = !1,
        ...
        c = this,
        d = function () {
            a = !0, jQuery.facebox.settings.closeImage = "/images/closelabel.png", jQuery.facebox.settings.loadingImage = "/images/loading.gif", $("#page_settings").empty(), jQuery.facebox({
                div: "#page_settings"
            });
            var b = $("#facebox");
            jQuery("div#facebox div.popup div.content").addClass("spage"), b.draggable({
                opacity: .5
            })
        };
    !window.fb_frame && Loc.locale == "ru" ? $("#turbo_icon").click(turbo_image_click_func()) : $("#turbo_icon").click(d), $("#page_settings_link").click(d), $(document).bind("afterClose.facebox", function () {
        ...
        if (a && b == !1) {
            ...
            var f = $('<table class="setting_tbl"></table>').appendTo(d),
                e = jQuery('<tr class="opt_line" style=""></tr>').appendTo(f),
                g = $('<span id=""></span>').html(Loc.ps_turbo_msg);
            ...
            if (!window.fb_frame) {
                ...
                var j = jQuery('<input type="checkbox"></input>').appendTo($("<td></td>").appendTo(e)),
                    k = $.cookie("sh");
            ...
            var e = jQuery('<tr class="opt_line" style=""></tr>').appendTo(f),
                l = $('<td class="s_c1"></td>').appendTo(e);
            jQuery("<span></span>").html(Loc.ps_disable_sharing).appendTo(l);
            var m = jQuery('<input type="checkbox"></input>').appendTo($("<td></td>").appendTo(e)),
                n = $('<div border="0" align="middle" style="display:none;left:400px;" class="spinner_img"></div>').appendTo(l);
            ...
            var o = $("<td></td>").appendTo(e),
                p = $('<input id="gp_thre_val" autocomplete="off" class="input_text" value="' + c.gp_confirm_thre_val() + '"></input>').appendTo(o);
            ...
            if (supports_local_storage()) {
                ...
                if (typeof Notification == "undefined") $('<div class="set_line"></div>').html(Loc.ps_notif_unavailable).appendTo(d);
                else {
                    var f = $('<table class="setting_tbl"></table>').appendTo(d),
                        q = ["death", "duel", "mquest", "quest", "levelup", "sa", "return_town", "invite", "fr_msg"],
                        r = function (a) {
                            return function (b) {
                    ...
                    $.each(q, function (a, b) {
                        var d = jQuery('<tr class="opt_line"></tr>').appendTo(f),
                            e = $('<span id=""></span>').html(Loc["ps_notif_" + b]).attr("title", Loc["ps_notif_" + b + "_d"]);
    ...
    $(".h_min").click(function () {
        var b = jQuery(this).parent().parent().parent().attr("id"),
            c = jQuery(this).parent().parent().parent().children(".block_content"),
            d = jQuery(this).parent().parent().parent().children(".block_h").children(".r_slot").children();
...
var create_messages_content = function (a, b, c, d, e, f) {
    ...
    var g = $('<div class="frline fsearchbar"></div>'),
        h = $("<input></input>").attr({
            "class": "input_text",
            type: "text"
        });
        ...
        return function (e) {
            ...
            if (i == undefined) {
                ...
                l.attr("title", Loc.fr_gch_close_title), l.click(function (a) {
                    b.unregister(f), i.remove(), d["gc_" + c] = undefined, a.stopPropagation()
                ...
                var n = $('<div class="frMsgBlock"></div>'),
                    o = $('<div class="fr_chat_header">&nbsp;</div>').appendTo(n),
                    p = $(window).height(),
                    q = p - 300;
                q < 275 && (q = 275);
                var r = $('<div style="height:' + q + 'px;" class="frMsgArea"></div>').appendTo(n);
                i.spinner = $('<div border="0" align="middle" class="msg_spinner spinner_img" style="display:none;right:25px;"></div>'), n.append(i.spinner);
                var s = $("<div></div>").appendTo(r);
                s.append($('<div class="fr_msg_loading"></div>').html(Loc.fr_loading_messages)), n.msg_area = s, n.msg_area_w = r;
                var t = $('<div class="frInputArea"></div>').appendTo(n),
                    u = $('<textarea style="width:340px;height:28px;font-size:12px;"></textarea>').appendTo(t);
                i.t_area = u, u.bind("focus", function () {
                    i.new_msg_mark && (i.new_msg_mark.remove(), i.new_msg_mark = undefined)
                }), window.setTimeout(function () {
                    u.focus()
                }, 1), u.autogrow(), u.attr("disabled", "disabled");
                var v = function (b, c) {
                    return function (d) {
                        if (d.which == 13) {
                            d.preventDefault();
                            var e = b.val();
                            b.attr("disabled", "disabled"), set_msg_update(a), i.spinner.show(), $.post(base_api_url, {
                                a: get_cmd_id("7Ub7bq4b4fKpsydXuVOm"),
                                b: prepare_args(JSON.stringify({
                                    m: e,
                                    sid: a.messages.gc_m_id
                                }))
                            }, function (d) {
                                d.status == "success" ? (a.messages.process_msg_for_guild(a.messages, c, d.msg.reverse()), b.val(""), b.removeAttr("disabled"), b.trigger("change")) : d.status == "error" && d.desc && (i.spinner.hide(), i.error_line.addClass("t_error"), i.error_line.text(d.desc), i.error_line.slideDown("fast", function () {
                                    window.setTimeout(function () {
                ...
                u.keypress(v(u, c)), i.m_block = n, i.append(n), $(".frMsgBlock").hide(), n.show(), i.show_new_msg_flag = function () {
                    ...
                    $(u).is(":focus") || i.show_new_msg_flag(), n.css("display") != "none" && a.messages.load_msg_for_guild(c, a.messages.gc_m_id)
                }, i.error_line = $('<div class="gc_status" style="display:none;"></div>').appendTo(n), s.update = function () {
                    gv_log("gc messages update " + n.children(".frdelete_link").length);
                    if (n.children(".frclose_link").length == 0) {
                        o.text(localize(Loc.fr_gch_w_title, {
                            guild: a.state.guild()
                        }));
                        ...
                        if (a.messages.gc_ext_perms) {
                            ...
                            d.attr("title", Loc.fr_chat_banned_link), d.click(function () {
                                i.spinner.show(), $.post(base_api_url, {
                                    a: get_cmd_id("R2jD74ywz4d7QXjcQ75r")
                                }, function (a) {
                                    i.spinner.hide();
                                    if (a.status == "error" && a.desc) i.error_line.addClass("t_error"), i.error_line.text(a.desc), i.error_line.slideDown("fast", function () {
                                        ...
                                        $(document).bind("afterClose.facebox", function () {
                                            ...
                                            if (c) {
                                                ...
                                                var d = jQuery("div#facebox div.popup div.content");
                                                d.empty();
                                                if (a.gods.length == 0) $('<div class="set_line" style="margin:1em;"></div>').html(Loc.fr_chat_banned_empty).appendTo(d);
                                                else {
                                                    d.append(jQuery("<h4></h4>").html(Loc.fr_chat_banned));
                                                    var e = jQuery('<div class="set_line"></div>').appendTo(d),
                                                        f = $('<table id="gc_banned_t"></table').appendTo(e),
                                                        g = $('<div style="display:none;">test</div>').appendTo(e),
                                                        h = $("<tr></tr>").appendTo(f);
                                                    ...
                                                    for (var j in a.gods) {
                                                        ...
                                                        if (k.a) {
                                                            var m = $('<div class="div_link"></div>').html(Loc.fr_chat_unban).appendTo(l),
                                                                n = function (a, b, c, d) {
                                                                    return function (e) {
                                                                        var f = confirm(localize(Loc.fr_chat_unban_confirm, {
                                                                            god: a.u
                                                                        }));
                                                                        if (!f) return !1;
                                                                        b.show();
                                        ...
                                        }), jQuery.facebox.settings.closeImage = "/images/closelabel.png", jQuery.facebox.settings.loadingImage = "/images/loading.gif", jQuery.facebox({
                                            div: "#page_settings"
                                        });
                                        var d = $("#facebox");
                                        jQuery("div#facebox div.popup div.content").addClass("spage"), d.draggable({
                                            opacity: .5
                                        })
                                    }
                                })
                    ...
                    s.empty();
                    var e = a.messages.get_msg_for_guild(c);
                    a.messages.wr_perms ? u.attr("disabled") && (u.removeAttr("disabled"), u.val(""), u.focus()) : (u.attr("disabled", "disabled"), u.val(Loc.fr_chat_wr_unavail));
                    if (e && e.length > 0) {
                        for (id in e) {
                            var f = e[id],
                                g = $('<div class="fr_msg_l"></div>').text(f.m),
                                h = new Date;
                            h.setISO8601(f.t), h.setTime(h.getTime() + window.time_diff);
                            var j = new Date,
                                k = time_ago_interval(h),
                                l;
                            j - h < 864e5 ? l = formatted_date(h, !0) : l = formatted_date_full(h, !0);
                            var m = "fr_msg_meta gc_fr_msg_meta fr_auth_lab",
                                p = $('<div class="' + m + '"></div>');
                            g.append(p);
                            var q = $('<span class="gc_fr_msg_meta gc_fr_god gc_fr_el"></span>').text(f.u).attr("title", Loc.fr_chat_name).appendTo(p),
                                t = function (a) {
                                    return function (b) {
                                        u.val().length == 0 ? u.val("@" + a) : u.val(u.val() + " @" + a), u.focus(), b.stopPropagation();
                                        return !1
                                    }
                                };
                            q.click(t(f.u)), $('<span class="gc_fr_el"></span>').text(k).attr("title", l).appendTo(p);
                            if (a.messages.gc_ext_perms && f.u != a.state.godname()) {
                                var v = $('<span style="display:none;" class="gc_fr_bg gc_fr_ban">[☠]</span>');
                                v.attr("title", Loc.fr_chat_ban_link).prependTo(p);
                                var w = function (a, b, c) {
                                    return function () {
                                        var d = confirm(localize(Loc.fr_chat_ban_confirm, {
                                            god: b
                                        }));
                                        if (!d) return !1;
                                        i.spinner.show(), $.post(base_api_url, {
                            ...
                            var x = function (a) {
                                ...
                                y;
                            f.u != a.state.godname() && (y = $('<span style="display:none;" class="gc_fr_bg gc_fr_page">[➠]</span>'), y.attr("title", Loc.fr_chat_to_ppage).prependTo(p), y.click(x(f.u)));
                            var z = function (a, b) {
                                    return function () {
                            ...
                            g.mouseover(z(v, y)), g.mouseout(A(v, y));
                            var B = f.m.indexOf("@" + a.state.godname()),
                                C = f.m[B + a.state.godname().length + 1];
                            B != -1 && (C == undefined || !C.match(/[а-яёa-z0-9A-ZА-ЯЁ]/)) && g.addClass("m_infl"), f.s ? g.addClass("gc_sys_msg") : f.u == a.state.godname() && g.addClass("fr_msg_l_my"), s.append(g)
                        }
                        var D;
                        s.scrollHeight ? D = s.scrollHeight : D = s.height(), s.current_position && (D = D - s.current_position, s.current_position = undefined), r.scrollTop(D)
                    } else a.messages.gc_error ? (s.append($('<div class="fr_no_messages"></div>').text(a.messages.gc_error)), u.attr("disabled", "disabled")) : (s.append($('<div class="fr_no_messages"></div>').html(Loc.fr_gch_no_messages)), u.attr("disabled") && a.messages.wr_perms && (u.removeAttr("disabled"), u.val(""), u.focus()));
                    i.spinner.css("display") != "none" && i.spinner.hide()
                }, b.register("gc_mid", i), b.register(f, s), a.messages.load_msg_for_guild(c, undefined), g(i), i.fr_name_w.click(h(i, n))
    ...
    var l = function (c) {
        ...
        if (f == undefined) {
            ...
            var n = $('<div class="frMsgBlock"></div>'),
                o = $('<div class="fr_chat_header">&nbsp;</div>').appendTo(n),
                p = $('<div style="height:275px;" class="frMsgArea"></div>').appendTo(n);
            ...
            var t = function (b, c) {
                return function (d) {
                    if (d.which == 13) {
                        ...
                        b.attr("disabled", "disabled"), set_msg_update(a), f.spinner.show(), $.post(base_api_url, {
                            a: get_cmd_id("GJyYqhQtKRYCWFp1UwM5"),
                            b: prepare_args(JSON.stringify({
                                to: c,
                                msg: e
                            }))
                        }, function (a) {
                            b.val(""), b.removeAttr("disabled"), b.trigger("change")
                        })
                    }
                }
            };
            s.keypress(t(s, c)), f.m_block = n, f.append(n), $(".frMsgBlock").hide(), n.show(), f.show_new_msg_flag = function () {
                f && f.new_msg_mark == undefined && (f.new_msg_mark = $('<span class="fr_new_msg">★</span>'), f.new_msg_mark.attr("title", Loc.fr_new_messages_helper_title), f.new_msg_mark.prependTo(j))
            }, f.update = function () {
                gv_log(c + " nm update");
                if (n.children(".frdelete_link").length == 0) {
                    var b = a.messages.h_friends[c],
                        e = Loc.fr_god_m,
                        f = Loc.fr_god_m_link;
                    ...
                    o.html(i);
                    var j = $('<div class="frdelete_link div_link">☠</div>').appendTo(n),
                        k = $('<div class="frclose_link div_link">[x]</div>').appendTo(n),
                        l = $('<div class="fr_msg_delete_link div_link">♲</div>').appendTo(n);
                ...
                q.empty();
                var s = a.messages.get_msg_for_friend(c);
                if (s && s.length > 0) {
                    var t = a.messages.h_pages[c];
                    if (s.length % 25 == 0 && (q.last_page_num == undefined || q.last_page_num != t || q.max_page_num && q.max_page_num > t)) {
                        var u = $('<div class="fr_msg_l fr_msg_next m_hover"></div>'),
                            v = $('<img border="0" align="middle" class="fr_msg_spinner" style="display:none;" src="/images/spinner.gif"></img>');
                        u.html(Loc.fr_more_messages), v.appendTo(u), u.click(function () {
                            q.last_page_num = a.messages.h_pages[c], v.show(), a.messages.load_next_page_for_friend(c, a.messages.h_pages[c] + 1), q.scrollHeight ? q.current_position = q.scrollHeight : q.current_position = q.height()
                        }), q.append(u)
                    }
                    q.max_page_num = t;
                    for (id in s) {
                        var w = s[id],
                            x = $('<div class="fr_msg_l"></div>').text(w.msg),
                            y = new Date;
                        y.setISO8601(w.sent_at), y.setTime(y.getTime() + window.time_diff);
                        var z = new Date,
                            A;
                        z - y < 864e5 ? A = formatted_date(y, !0) : A = formatted_date_full(y, !0);
                        var B = $('<div style="display:none;" class="fr_msg_meta"></div>').html(A);
                        x.append(B);
                        var C = $('<div style="display:none;" class="fr_msg_delete">[x]</div>');
                        C.attr("title", Loc.fr_msg_delete_title), x.append(C);
                        var D = function (b, c) {
                            return function () {
                        ...
                        x.mouseover(E(B, C)), x.mouseout(F(B, C)), w.from == a.state.godname() && x.addClass("fr_msg_l_my"), q.append(x)
                    }
                    var G;
                    q.scrollHeight ? G = q.scrollHeight : G = q.height(), q.current_position && (G = G - q.current_position, q.current_position = undefined), p.scrollTop(G)
    ...
    d.update = function () {
        ...
        for (id in a.messages.to_update) {
            ...
            if (d["fc_" + c]) {
                if (i && i == "upd")
                    if (d["fc_" + c].hasClass("frbutton_pressed")) {
                        a.messages.mark_as_read(c);
                        var j = a.messages.last_msg_for_friend_author(c);
                        j != a.state.godname() && a.nm.notify_all.apply(a.nm, [
                            ["new_msg_star"]
                        ])
                    } else if (i && i == "upd") {
                    a.messages.mark_as_read(c), !d["fc_" + c].hasClass("frbutton_pressed") && f.msg.from != a.state.godname() && (d["fc_" + c].show_new_msg_flag(), a.nm.notify_all.apply(a.nm, [
                        ["new_msg_star"]
                    ]));
                    var k = d["fc_" + c],
                        m = k.parent();
            ...
            } else i && i == "upd" && (a.messages.h_friends[c].msg && a.messages.h_friends[c].msg.from == a.state.godname() ? a.messages.mark_as_read(c) : g && g.new_msg_mark == undefined && (g.new_msg_mark = $('<span class="fr_new_msg">★</span>'), g.new_msg_mark.attr("title", Loc.fr_new_messages_helper_title), g.new_msg_mark.prependTo(g)))
        }
        a.messages.to_update = [];
        for (id in b) {
            var f = a.messages.h_friends[b[id].name],
                n, c = f.name,
                g = d["fl_" + c];
            if (g == undefined) {
                ...
                var q = function (b, c) {
                    ...
                    r = $('<div  style="display:none;" class="frlist_right div_link">➠</div>'),
                    s = function (a) {
                        return function (b) {
                            window.open("/gods/" + a), b.stopPropagation()
                        }
...
ScreenManager.prototype.create_messages_sh = function () {
    var a = $("#main_wrapper"),
        b = this,
        c = this.nm,
        d = $('<div class="msgDockWrapper"></div>');
    ...
    e.attr("title", Loc.fr_link_badge_title), e.update = function () {
    ...
    var f = $('<div style="display:none;" class="fr_new_badge gc_new_badge gc_new_badge_pos"></div>').appendTo(d.dock);
    f.attr("title", Loc.fr_gch_link_badge_title), f.update = function () {
        var a = b.messages.get_gc_msg_cnt(),
            c = "__guildchat";
        a > 0 && (d["gc_" + c] == undefined || d["gc_" + c].hasClass("frbutton_pressed") == !1) ? (this.html(a), this.show()) : this.hide()
    }, b.nm.register("gc_msg_badge", f), d.dock.new_badge_gc = f, f.update.call(f), d.fpopup = $('<div class="msgDockPopup"></div>').hide(), d.f_list = $('<div class="msgDockPopupW"></div>');
    var g = $(window).height(),
        h = g - 200;
    h < 200 && (h = 200), d.f_list.attr("style", "max-height:" + h + "px;"), d.append(d.dock), d.append(d.chat_placeholder), a.append(d), d.append(d.fpopup), d.f_list.appendTo(d.fpopup);
    var i = undefined;
    d.dock.click(function () {
        if (d.fpopup.css("display") == "none") {
            d.fpopup.show(), d.dock.addClass("frbutton_m_pressed");
            var a = $(".msgDockPopupW")[0];
            setTimeout(function () {
                var a = jQuery(".msgDockPopupW")[0];
                i == undefined ? a.scrollTop = a.scrollHeight : a.scrollTop = i
            ...
            var a = $(".msgDockPopupW")[0];
            i = $(a).scrollTop(), d.dock.removeClass("frbutton_m_pressed"), d.fpopup.hide()
        }
    ...
    if (a) {
        var g = this,
            h = this.get_left_slot_by_parent_ref(this.blocks.pantheons),
            i = $('<div id="panth_new_badge" class="fr_new_badge panth_badge">1</div>').appendTo(h);
        i.update = function () {
            ...
            i.hide(), g.nm.notify_all.apply(g.nm, [
                ["pantheons"]
            ])
        }, this.block_clbks.h_pantheons = function () {}, this.nm.register("pantheons_badge", i), this.ui.pantheons_block(this, a, this.state, !0, function () {
    ...
    a = this.get_block_content("equipment"), a && this.ui.equipment_block(this, !1, a, this.state.equipment, "equipment"), a = this.get_block_content("skills"), a && (this.nm.register("skills", this.ui.create_skills(this, this.state)).appendTo(a), $('<div class="line"></div>').appendTo(a)), window.gv3d && (a = this.get_block_content("gl3d"), a && this.create_3d_block(a)), a = this.get_block_content("ies_block"), a && (this.ui.create_ies_block(this, a, this.state), $('<div class="line"></div>').appendTo(a)), document.title = this.ui.make_title_line(this.state.stats.gender, this.state.stats.ggender, this.state.stats.godname, {
        value: ""
    })
    ...
    if (a) {
        var b = this.get_a_block_caption("alls"),
            c = this.get_spinner(this.a_blocks.alls);
    ...
    if (a) {
        var b = this.get_a_block_caption("opps"),
            c = this.get_spinner(this.a_blocks.opps);
    ...
    if (a)
        if (this.state.fight_type() == "dungeon") this.a_blocks.o_info.attr("style", "display:none;");
        else {
    ...
    a = this.get_a_block_content("o_equipment"), a && (this.state.o_equipment && this.state.o_equipment.weapon ? this.ui.equipment_block(this, !1, a, this.state.o_equipment, "o_equipment") : this.a_blocks.o_equipment.attr("style", "display:none;")), a = this.get_a_block_content("o_inventory");
    if (a)
        if (this.state.fight_type() == "dungeon") this.a_blocks.o_inventory.attr("style", "display:none;");
        else {
            var i = !1;
    ...
    a = this.get_a_block_content("m_opponent"), a && (this.state.fight_type() == "dungeon" ? this.a_blocks.m_opponent.attr("style", "display:none;") : this.ui.create_m_oponent_block(this, a, this.state)), document.title = "(!) " + this.ui.make_title_line(this.state.stats.gender, this.state.stats.ggender, this.state.stats.godname, {
        value: ""
    });
...
(function () {
    ...
    if (b.substring(0, c.length) == c) this.callback_obj.on_s_expired_callback.call(this.callback_obj);
    else if (this.state == "disconnected" && b.substring(0, connect_string.length) == connect_string) {
        var d = [];
    ...
    if (this.packet_started) this.buffer = this.buffer + a, this.buffer.length == this.packet_size ? (this.packet_started = !1, this.process_packet(this.buffer), this.buffer = "") : (gv_error("incorrect package length 2: [" + this.buffer.length + "][" + this.packet_size + "][" + this.buffer + "]"), this.packet_started = !1, this.callback_obj.on_decode_error && this.callback_obj.on_decode_error.call(this.callback_obj));
    else {
        var b = a;
